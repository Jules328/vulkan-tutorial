...
static VERTICES: &[Vertex] = &[
    Vertex::new(vec2(-0.5, -0.5), vec4(1.0, 0.0, 0.0, 0.5), vec2(0.0, 0.0)),
    Vertex::new(vec2(0.5, -0.5), vec4(0.0, 1.0, 0.0, 0.8), vec2(1.0, 0.0)),
    Vertex::new(vec2(0.5, 0.5), vec4(0.0, 0.0, 1.0, 0.5), vec2(1.0, 1.0)),
    Vertex::new(vec2(-0.5, 0.5), vec4(1.0, 1.0, 1.0, 0.2), vec2(0.0, 1.0)),
];
...
impl App {
    ...
    unsafe fn update_uniform_buffer(&self, image_index: usize) -> Result<()> {
        ...
        // Account for inverted y direction of Vulkan graphics
        proj[1][1] *= -1.0;
...
impl Vertex {
    const fn new(pos: Vec2, color: Vec4, tex_coord: Vec2) -> Self {
    ...
    fn attribute_descriptions() -> [vk::VertexInputAttributeDescription; 3] {
        ...
        let tex_coord = vk::VertexInputAttributeDescription::builder()
            ...
            .location(2)
            .format(vk::Format::R32G32_SFLOAT)
            .offset((size_of::<Vec2>() + size_of::<Vec4>()) as u32)
            .build();
